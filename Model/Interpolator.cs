...
namespace Model
{
    class Interpolator
    {
        public double Interpolate(int FirstRow, double X, double Y, double deta_X, double deta_Y, int dig_X, int dig_Y)
        {
            double Z1;
            double Z2;
            double Z;
            ...
            int colNum1 = 2;
            double col = (Math.Round(Y, dig_Y) - 0) / deta_Y;//四舍五入获取行位置//0.0002是表横坐标相邻间距
